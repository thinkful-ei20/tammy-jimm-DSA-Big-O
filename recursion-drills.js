...
//O(n)
//It will call the function 'num' number of times 
...
//O(n)
//It will double each index of the array for the length of the array
...
//O(n)
//It will call and place the first index at the end for the length of 'str'
...
//O(n)
//It will call the function 'n' times
